	...
	public static void main(String[] args) {
		...
		final int TOPPING = 5;
			...
			int input = Integer.parseInt(strinput);
				...
				int price = (input == 1) ? VANILLA : (input == 2) ? CHOCOLATE : 0;
				String iceCreamFlavor = (input == 1) ? "Vanilla" : (input == 2) ? "Chocolate" : "Chocolate";
		    ...
		    JOptionPane.showMessageDialog(null,"ERROR: Wrong choice!"
			 ...
			 input = Integer.parseInt(strinput);
			 	...
			 	iceCreamFlavor = (input == 1) ? "Vanilla" : (input == 2) ? "Chocolate" : "Chocolate";
			}
	        ...
	        JOptionPane.showMessageDialog(null,
	                 "You choose " + iceCreamFlavor +" Flavor"+
	                 "\nAnd " + toppingWith+
